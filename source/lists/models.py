...
class GroupList(models.Model):
    title = models.CharField(max_length=128, default="Your Groups")
    created_at = models.DateTimeField(auto_now=True)
    creator = models.ForeignKey(
        User, null=True, related_name="grouplist_s", on_delete=models.CASCADE
    )
...
class Group(models.Model):
    ...
    is_finished = models.BooleanField(default=False)
    creator = models.ForeignKey(
        User, null=True, related_name="group_s", on_delete=models.CASCADE
    )
    grouplist = models.ForeignKey(
        GroupList, related_name="group_s", on_delete=models.CASCADE
    )
